...
```
É bem comum o método **"include?"** para verificar se no meu array existe um determinado valor que desejo. Outro método muito usado é o **"length"** ou **"count"** pra verficar o tamanho do meu array.
```
array = [1, 2, 3, 4, 5]
