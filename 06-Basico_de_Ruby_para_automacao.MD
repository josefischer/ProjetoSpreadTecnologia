...
==  # igual
!=  # diferente
if not, unless, if !variavel # Operador lógico que representa a negação (inverso) da variável atual. Se ela for verdade, torna-se falsa, e vice-versa. O uso do ! para ter a condição negativa é a mais comum no ruby, eu prefiro o uso do not, acho mais claro de se entender.
