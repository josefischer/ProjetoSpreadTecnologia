...
No Ruby tudo é objeto, ou seja uma variável é um objeto e pertence a uma determinada classe:
Através do método "class" podemos ver a classe que ela pertence e que tipo ela é:
```ruby
puts 5.class
puts 3.14.class
puts "teste".class
